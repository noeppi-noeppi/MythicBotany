...
public class ModBlocks {
    ...
    public static final BlockMjoellnir mjoellnir = new BlockMjoellnir(MythicBotany.getInstance(), Properties.of(Material.STONE).strength(-1.0F, 3600000.0F).noLootTable(), new Item.Properties().stacksTo(1).rarity(Rarity.EPIC));
    ...
    public static final BlockBE<TileReturnPortal> returnPortal = new BlockReturnPortal(MythicBotany.getInstance(), BlockBehaviour.Properties.of(Material.PORTAL).noCollission().noLootTable().strength(-1.0F).sound(SoundType.GLASS).lightLevel(state -> 4));
}
