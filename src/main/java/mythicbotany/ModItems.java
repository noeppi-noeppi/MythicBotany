...
public class ModItems {
    ...
    public static final Item alfsteelSword = new AlfsteelSword(new Properties().group(MythicBotany.TAB).maxStackSize(1).func_234689_a_());
    public static final Item alfsteelPick = new AlfsteelPick(new Properties().group(MythicBotany.TAB).maxStackSize(1).func_234689_a_());
    public static final Item alfsteelAxe = new AlfsteelAxe(new Properties().group(MythicBotany.TAB).maxStackSize(1).func_234689_a_());
    public static final Item alfsteelHelmet = new AlfsteelHelm(new Properties().group(MythicBotany.TAB).maxStackSize(1).func_234689_a_());
