...
public class ModItems {
    ...
    public static final Item alfsteelChest = new AlfsteelArmor(EquipmentSlotType.CHEST, new Properties().group(MythicBotany.getInstance().tab).maxStackSize(1).isImmuneToFire());
    public static final Item alfsteelLegs = new AlfsteelArmor(EquipmentSlotType.LEGS, new Properties().group(MythicBotany.getInstance().tab).maxStackSize(1).isImmuneToFire());
    ...
    public static final Item greatestManaRing = new GreatestManaRing(new Properties().group(MythicBotany.getInstance().tab).maxStackSize(1).isImmuneToFire());
    public static final Item greatestAuraRing = new GreatestAuraRing(new Properties().group(MythicBotany.getInstance().tab).maxStackSize(1).isImmuneToFire());
