...
@RegisterClass(registry = "FOLIAGE_PLACER_TYPE_REGISTRY")
public class RandomFoliagePlacer extends FoliagePlacer {
    ...
    @Override
    protected void createFoliage(@Nonnull LevelSimulatedReader level, @Nonnull BiConsumer<BlockPos, BlockState> blockSetter, RandomSource random, @Nonnull TreeConfiguration config, int maxFreeTreeHeight, @Nonnull FoliageAttachment attachment, int foliageHeight, int foliageRadius, int offset) {
    ...
    private boolean placeLeave(LevelSimulatedReader level, BiConsumer<BlockPos, BlockState> blockSetter, BlockPos pos, RandomSource rand, TreeConfiguration config) {
