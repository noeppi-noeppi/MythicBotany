...
public class LargeManaComponent implements ICustomComponent {
    ...
    public void render(@Nonnull MatrixStack matrixStack, IComponentRenderContext ctx, float partialTicks, int mouseX, int mouseY) {
        ...
        font.func_243248_b(matrixStack, manaUsage, this.x + 51 - font.getStringPropertyWidth(manaUsage) / 2, this.y, 0x66000000);
        ...
        //noinspection IntegerDivisionInFloatingPointContext
        font.func_243248_b(matrixStack, ratioTc, this.x + 51 - font.getStringPropertyWidth(ratioTc) / 2, this.y + 15, 0x777777);
    }
