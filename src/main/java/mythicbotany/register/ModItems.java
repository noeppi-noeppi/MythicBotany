...
public class ModItems {
    ...
    public static final Item asgardRune = new RuneItem(new Properties().tab(MythicBotany.getInstance().tab));
    public static final Item vanaheimRune = new RuneItem(new Properties().tab(MythicBotany.getInstance().tab));
    public static final Item alfheimRune = new RuneItem(new Properties().tab(MythicBotany.getInstance().tab));
    public static final Item midgardRune = new RuneItem(new Properties().tab(MythicBotany.getInstance().tab));
    public static final Item joetunheimRune = new RuneItem(new Properties().tab(MythicBotany.getInstance().tab));
    public static final Item muspelheimRune = new RuneItem(new Properties().tab(MythicBotany.getInstance().tab));
    public static final Item niflheimRune = new RuneItem(new Properties().tab(MythicBotany.getInstance().tab));
    public static final Item nidavellirRune = new RuneItem(new Properties().tab(MythicBotany.getInstance().tab));
    public static final Item helheimRune = new RuneItem(new Properties().tab(MythicBotany.getInstance().tab));
    ...
    public static final Item andwariRing = new BaubleItem(new Properties().tab(MythicBotany.getInstance().tab).stacksTo(1).durability(32)) {};
