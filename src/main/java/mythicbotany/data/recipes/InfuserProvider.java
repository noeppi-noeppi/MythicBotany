...
public class InfuserProvider extends RecipeProvider {
    ...
    protected void registerRecipes(@Nonnull Consumer<IFinishedRecipe> consumer) {
        InfuserRecipeBuilder.infuserRecipe(ModItems.terrasteel)
                ...
                .build(consumer, new ResourceLocation(MythicBotany.MODID, "mythicbotany_infuser/" + Registry.ITEM.getKey(ModItems.terrasteel).getPath()));
        ...
        InfuserRecipeBuilder.infuserRecipe(mythicbotany.ModItems.alfsteelIngot)
                ...
                .setGroup("infuser")
                .addCriterion("has_item", hasItem(ModBlocks.manaInfuser))
                .build(consumer, new ResourceLocation(MythicBotany.MODID, "mythicbotany_infuser/" + Registry.ITEM.getKey(mythicbotany.ModItems.alfsteelIngot).getPath()));
    }
}
