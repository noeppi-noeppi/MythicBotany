...
public class SmithingProvider extends RecipeProvider {
    ...
    protected void registerRecipes(@Nonnull Consumer<IFinishedRecipe> consumer) {
        ...
        SmithingRecipeBuilder.smithingRecipe(Ingredient.fromItems(vazkii.botania.common.item.ModItems.terrasteelChest), alfsteel2, ModItems.alfsteelChest).addCriterion("alfsteel_chestplate_criteria", RecipeUnlockedTrigger.create(new ResourceLocation("botania", "terra_chest"))).build(consumer, new ResourceLocation(MythicBotany.getInstance().modid, "alfsteel_chestplate_smithing"));
        SmithingRecipeBuilder.smithingRecipe(Ingredient.fromItems(vazkii.botania.common.item.ModItems.terrasteelLegs), alfsteel2, ModItems.alfsteelLegs).addCriterion("alfsteel_leggings_criteria", RecipeUnlockedTrigger.create(new ResourceLocation("botania", "terra_legs"))).build(consumer, new ResourceLocation(MythicBotany.getInstance().modid, "alfsteel_leggings_smithing"));
        ...
        SmithingRecipeBuilder.smithingRecipe(Ingredient.fromItems(vazkii.botania.common.item.ModItems.manaRingGreater), alfsteel, ModItems.greatestManaRing).addCriterion("alfsteel_mana_ring_criteria", RecipeUnlockedTrigger.create(new ResourceLocation("botania", "mana_ring_greater"))).build(consumer, new ResourceLocation(MythicBotany.getInstance().modid, "alfsteel_mana_ring_smithing"));
        SmithingRecipeBuilder.smithingRecipe(Ingredient.fromItems(vazkii.botania.common.item.ModItems.auraRingGreater), alfsteel, ModItems.greatestAuraRing).addCriterion("alfsteel_aura_ring_criteria", RecipeUnlockedTrigger.create(new ResourceLocation("botania", "aura_ring_greater"))).build(consumer, new ResourceLocation(MythicBotany.getInstance().modid, "alfsteel_aura_ring_smithing"));
    }
}
