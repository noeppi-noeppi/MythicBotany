...
public class SmithingProvider extends RecipeProvider {
	...
	protected void registerRecipes(@Nonnull Consumer<IFinishedRecipe> consumer) {
		...
		SmithingRecipeBuilder.func_240502_a_(Ingredient.fromItems(vazkii.botania.common.item.ModItems.terraAxe), alfsteel, ModItems.alfsteelAxe).func_240503_a_("alfsteel_axe_criteria", RecipeUnlockedTrigger.func_235675_a_(new ResourceLocation("botania", "terra_axe"))).func_240505_a_(consumer, new ResourceLocation(MythicBotany.MODID, "alfsteel_axe_smithing"));
		SmithingRecipeBuilder.func_240502_a_(Ingredient.fromItems(vazkii.botania.common.item.ModItems.terrasteelHelm), alfsteel2, ModItems.alfsteelHelmet).func_240503_a_("alfsteel_helmet_criteria", RecipeUnlockedTrigger.func_235675_a_(new ResourceLocation("botania", "terra_helm"))).func_240505_a_(consumer, new ResourceLocation(MythicBotany.MODID, "alfsteel_helmet_smithing"));
