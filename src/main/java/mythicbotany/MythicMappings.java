...
public class MythicMappings {
    ...
    public static void remapItems(RegistryEvent.MissingMappingsEvent<Item> event) {
        for (RegistryEvent.MissingMappingsEvent.Mapping<Item> mapping : event.getMappings(MythicBotany.getInstance().modid)) {
